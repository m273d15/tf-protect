...
find_protected_resources_with_violations(tfprotect_types_config) = {msg |
	...
	msgs := (validate_action("create", resource_type, tfprotect_types_config[resource_type]) | validate_action("update", resource_type, tfprotect_types_config[resource_type])) | validate_action("delete", resource_type, tfprotect_types_config[resource_type])
